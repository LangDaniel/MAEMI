 # modified version of: https://github.com/facebookresearch/mae/blob/main/main_finetune.py
...
from .util.io_manager import get_output_folder, copy_files, Args
...
def main(args, dataset_train, dataset_val):
    ...
    # freeze all layers till args.finetune_from
    for _, p in model.named_parameters():
        p.requires_grad = False
    for b in range(args.finetune_from, len(model.blocks)):
        for _, p in model.blocks[b].named_parameters():
    ...
    if mixup_fn is not None:
        ...
        train_criterion = val_criterion = criterion
