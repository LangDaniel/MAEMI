...
class MaskedAutoencoderViT_3D(nn.Module):
    ...
    def __init__(self, img_size: tuple, patch_size: tuple, in_chans,
        ...
        self.pos_embed = nn.Parameter(torch.zeros(1, total_num_patches + 1, embed_dim), requires_grad=False)  # fixed sin-cos embedding
        ...
        self.decoder_pos_embed = nn.Parameter(torch.zeros(1, total_num_patches + 1, decoder_embed_dim), requires_grad=False)  # fixed sin-cos embedding
